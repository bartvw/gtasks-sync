# Capability: bidirectional-field-sync

## Purpose

Provides per-field bidirectional sync between TaskNotes frontmatter and Google Tasks, using sentinel values to detect which side changed each field and resolve conflicts according to a configurable strategy.

# Capability: google-task-import

## Purpose

After the reconciliation loop, identifies active Google Tasks that were not matched to any vault note (orphans) and creates a new Obsidian note for each orphan when the import feature is enabled.
